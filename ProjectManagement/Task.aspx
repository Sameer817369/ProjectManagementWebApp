<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.master" CodeBehind="Task.aspx.cs" Inherits="ProjectManagement.Task" %>
  ...
  <div class="container mt-5">
      <div class="card shadow-lg border-0 rounded-3">
           ...
           <div class="card-header bg-success bg-gradient text-center py-4">
               <h2 class="text-white fw-bold">Task Management</h2>
           </div>
               <!-- Card Body -->
           <div class="card-body p-4">
               <div class="table-responsive">
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TASK_ID" DataSourceID="SqlDataSource1" CssClass="table table-bordered table-striped table-hover">
                        <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;TASK&quot; WHERE &quot;TASK_ID&quot; = :TASK_ID" InsertCommand="INSERT INTO &quot;TASK&quot; (&quot;TASK_ID&quot;, &quot;TASK_NAME&quot;, &quot;START_DATE&quot;, &quot;DUE_DATE&quot;, &quot;STATUS&quot;) VALUES (:TASK_ID, :TASK_NAME, :START_DATE, :DUE_DATE, :STATUS)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;TASK&quot;" UpdateCommand="UPDATE &quot;TASK&quot; SET &quot;TASK_NAME&quot; = :TASK_NAME, &quot;START_DATE&quot; = :START_DATE, &quot;DUE_DATE&quot; = :DUE_DATE, &quot;STATUS&quot; = :STATUS WHERE &quot;TASK_ID&quot; = :TASK_ID">
            <DeleteParameters>
